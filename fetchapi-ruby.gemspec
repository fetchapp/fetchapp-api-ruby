...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG", "lib/fetchapi/base.rb", "lib/fetchapi/download.rb", "lib/fetchapi/item.rb", "lib/fetchapi/order.rb", "lib/fetchapi.rb", "LICENSE", "README"]
  s.files = ["CHANGELOG", "fetchapi-ruby.gemspec", "fetchapi.gemspec", "init.rb", "lib/fetchapi/base.rb", "lib/fetchapi/download.rb", "lib/fetchapi/item.rb", "lib/fetchapi/order.rb", "lib/fetchapi.rb", "LICENSE", "Manifest", "Rakefile", "README", "spec/base_spec.rb", "spec/download_spec.rb", "spec/item_spec.rb", "spec/order_spec.rb"]
  s.has_rdoc = true
